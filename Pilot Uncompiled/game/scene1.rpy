...
male "{i}It's the first day of class. I remember facing this day so many times in high school.{/i}"
...
male "{i}I thought Worcester Polytechnic Institute would be the perfect school. I mean, WPI's great, but I have no skills when it comes to talking to people.{/i}"

male "{i}I'm determined to change that though! Starting now, I'll make a ton of friends! I'll go out, have fun, and make the most of my time!{/i}"
...
$ persistent.m = renpy.input("Type your name here")
