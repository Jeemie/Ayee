...
show quad at dim
show text "You've finished the rest of your classes for the day. You're walking through the Quad to meet your partner at the large tree on campus." at basicfade,truecenter with Pause(2.5)
pause 1
$ renpy.pause(2, hard='True')
hide text at basicfade


show text "You get halfway across the quad when you notice someone walking in the opposite direction." at basicfade,truecenter with Pause(2.5)
pause 1
$ renpy.pause(2, hard='True')
hide text at basicfade
