...
female "{i}In high school my friends and I would all make sure we got seats together. Although it's not like that made a difference, they weren't really my friends.{/i}"

female "{i}Everyone here is so much more real too. There's no sense in hiding yourself because there's nothing to be ashamed of! I can actually feel comfortable with myself and not have to watch everything I do.{/i}"

female "{i}I've already met so many different people! The girls in my dorm, the guys upstairs who bother us, sporty girls, bros, nerds, stoners- there's a bit of everything!{/i}"

female "{i}The one thing everyone definitely has in common is they're all so smart! I really hope I can keep up...{/i}"

female "{i}It's probably a good idea that I start to plan my schedule ahead right now! Let's see, next week I want to go see the art club and I'll have to meet with my academic advisor to talk about my schedule.{/i}"

female "{i}I'll probably need to go to some help sessions for these classes. They seem hard already – and we haven't even started! I also promised I'd meet Katie for lunches.{/i}"
...
female "Oh! I'm so sorry, I wasn't paying attention at all. Of course, my name is..."
...
f "Hi there! My name's %(f)s and we're gonna be partners!"

male "O-Oh! H-Hey there! Sorry, I wasn't paying too much attention before. My name is.."
