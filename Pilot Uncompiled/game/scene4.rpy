...
"{i}Is this something I should be sharing with a girl I just met? But there's something that makes me just...trust her.{/i}"
...
"{i}Maybe I could,but I don't want to think about that now, all of my focus should be on %(f)s.{/i}"
...
"{i}Wow, that's a big dream. It's kind of strange to know someone who already has their life planned out. Something inside me knows that she'll be able to do it, too.{/i}"
...
"{i}Your face is nearly red now as you try to reconcile her, but you completely stop when you see her wide grin.{/i}"
...
"{i}I got played! But I don't really mind. It feels nice talking to her like this.{/i}"

show dininghall at dim
hide flaughing at fastfade,center
show text "A bit later, you both check the time and find that you've been in the dining hall talking for 2 hours. You both get up in a hurry and exchange phone numbers before heading out. This is the first night at college that you've fallen asleep feeling truly content."  at basicfade,truecenter with Pause(2.5)
